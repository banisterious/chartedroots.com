...
- [I want to find and merge duplicate persons](/guides/research/find-and-merge-duplicates/) — often the right alternative to deletion
- [I want to add a new family member](/guides/research/add-new-family-member/)
