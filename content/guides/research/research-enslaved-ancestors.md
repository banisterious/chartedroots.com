...
See [the FAN clusters guide](/guides/research/analyze-fan-clusters/) for the analysis workflow once these networks are populated.
...
- [I want to analyze FAN clusters to break through a brick wall](/guides/research/analyze-fan-clusters/) — slaveholder community networks and FAN networks overlap completely
- [I want to organize a multi-document source collection](/guides/research/organize-multi-document-source-collections/) — the `source_parent` pattern in detail
- [I want to handle conflicting evidence between two sources](/guides/research/handle-conflicting-evidence/) — when an appraisement and a sale bill name the same person under different details
