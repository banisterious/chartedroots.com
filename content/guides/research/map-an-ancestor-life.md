...
Open the ancestor's note. The events section should list birth, death, and any residence / occupation / migration events with `place:` wikilinks. If events are missing, create them — see [I want to add a new family member](/guides/research/add-new-family-member/) for the event-creation flow.
...
For fictional places or hand-drawn-map places, see [I want to create a custom map of my fictional world](/guides/worldbuilding/create-custom-image-map/) — pixel coordinates apply instead of geographic.
...
![Heat-style overlay showing the geographic density of an ancestor's life events](/img/cr-map-heat.webp)
...
![Animated journey playback walking through an ancestor's life chronologically](/img/cr-map-journey-playback.webp)
...
- [I want to add a new family member](/guides/research/add-new-family-member/) — for adding life events
- I want to compare migration paths across siblings *(coming soon)*
- [I want to import a GEDCOM file and clean up the result](/guides/research/import-gedcom-and-cleanup/) — most life-event data comes in via GEDCOM
