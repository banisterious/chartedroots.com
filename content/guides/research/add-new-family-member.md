...
![Edit Person modal showing relationship fields with father, mother, and spouse populated](/img/cr-edit-person-modal.png)
...
- [I want to add my first person from scratch](/guides/research/add-first-person-manually/) — the foundational workflow this guide builds on
- [I want to set up per-fact source citations](/guides/research/set-up-source-tracking/) — to record the source for the birth event
- [I want to find and merge duplicate persons](/guides/research/find-and-merge-duplicates/) — if you accidentally create a duplicate
