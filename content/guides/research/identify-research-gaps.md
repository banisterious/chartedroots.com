...
- [I want to track research progress on a long-term project](/guides/research/track-research-progress/) — the Hoitink levels that gap-prioritization depends on
- [I want to set up per-fact source citations](/guides/research/set-up-source-tracking/) — the `sourced_*` arrays the gap card aggregates
- [I want to handle conflicting evidence between two sources](/guides/research/handle-conflicting-evidence/) — what to do when a "gap" is actually a conflict
