...
![Edit Person modal showing relationship fields and an events list, with parents and a spouse populated](/img/cr-edit-person-modal.png)
...
- I want to build a family tree for fictional characters *(coming soon, worldbuilding track)*
