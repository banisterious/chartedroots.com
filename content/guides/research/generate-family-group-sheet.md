...
![Family Group Sheet showing the parents, marriage, and children with dates and citations](/img/cr-report-family-group-sheet.png)
...
- [I want to generate a printable family tree](/guides/research/generate-printable-family-tree/) — for tree-shaped output instead of group-sheet shape
- [I want to generate a family reunion report](/guides/research/generate-family-reunion-report/) — for multi-generation output suitable for reunion handouts
- [I want to assemble a family history book](/guides/research/assemble-family-history-book/) — for book-length output that can include many group sheets
