...
- **Probate-packet FAN density.** Estate inventories, sale bills, and advancements each name many people. See [the enslaved-ancestors guide](/guides/research/research-enslaved-ancestors/) — the same source-roles substrate handles both Beyond Kin and FAN analysis, and the two converge in pre-emancipation records.
...
- [I want to research enslaved ancestors (Beyond Kin methodology)](/guides/research/research-enslaved-ancestors/) — same source-roles substrate, complementary methodology
- [I want to attach one source to multiple people](/guides/research/attach-one-source-to-multiple-people/) — the linking pattern roles depend on
- [I want to track research progress on a long-term project](/guides/research/track-research-progress/) — log what you tried and what came of it
