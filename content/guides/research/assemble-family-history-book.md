...
![Book Builder output: a printable PDF assembled from chapters of a family history](/img/cr-book-builder-output.png)
...
- [I want to generate a family group sheet](/guides/research/generate-family-group-sheet/) — for individual group sheets you can later embed as chapters
- [I want to generate a family reunion report](/guides/research/generate-family-reunion-report/) — for a lighter-weight printable
- [I want to generate a printable family tree](/guides/research/generate-printable-family-tree/) — for trees that become chapters in the book
