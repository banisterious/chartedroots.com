...
The Data Quality Preview surfaces Ancestry-specific quirks: place-name variants are common because Ancestry doesn't enforce a canonical form. Standardize them in the preview before importing — see [I want to import a GEDCOM file and clean up the result](/guides/research/import-gedcom-and-cleanup/) for the full preview workflow.
...
- [I want to migrate from Family Tree Maker](/guides/research/migrate-from-family-tree-maker/) — alternative if you also have an FTM tree synced from Ancestry
