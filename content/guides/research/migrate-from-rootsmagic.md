...
RootsMagic's GEDCOM is structured cleanly enough that the Data Quality Preview usually surfaces few issues. The preview's place-name variants pane is still worth a pass — Charted Roots normalizes US state abbreviations automatically, but other regional formatting (county names, country variants) benefits from explicit canonical-form choices. See [I want to import a GEDCOM file and clean up the result](/guides/research/import-gedcom-and-cleanup/) for the full preview workflow.
...
- [I want to find and merge duplicate persons](/guides/research/find-and-merge-duplicates/)
- [I want to set up per-fact source citations](/guides/research/set-up-source-tracking/) — to extend RootsMagic's source handling per-fact
