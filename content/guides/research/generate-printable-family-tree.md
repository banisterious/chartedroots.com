...
![Pedigree tree report rendered as a printable layout, with name and dates per node](/img/cr-report-pedigree-tree.png)
...
- [I want to add my first person from scratch](/guides/research/add-first-person-manually/)
- I want to print a wall-sized pedigree *(coming soon)*
