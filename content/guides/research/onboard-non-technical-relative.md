...
- [I want to add my first person from scratch](/guides/research/add-first-person-manually/) — the workflow you'll walk through together
- [I want to migrate from Ancestry](/guides/research/migrate-from-ancestry/) — if they have an existing Ancestry tree to bring across
- [I want to import a GEDCOM file and clean up the result](/guides/research/import-gedcom-and-cleanup/)
