...
- [I want to research enslaved ancestors (Beyond Kin methodology)](/guides/research/research-enslaved-ancestors/) — probate packets are the canonical use case for this pattern in pre-emancipation research
- [I want to attach one source to multiple people](/guides/research/attach-one-source-to-multiple-people/) — child documents typically attach to many people in the family group
- [I want to set up per-fact source citations](/guides/research/set-up-source-tracking/) — `sourced_*` arrays attach to children, not parents
