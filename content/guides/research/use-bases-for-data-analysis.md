...
![People base in Bases — table view with the view selector showing the built-in pre-configured views, a representative filter applied across the columns](/img/cr-guide-use-bases-people-view.png)
...
- [I want to find and merge duplicate persons](/guides/research/find-and-merge-duplicates/) — Bases can help spot duplicates by sorting on name + birth year
- [I want to compile a worldbuilding bible from my notes](/guides/worldbuilding/compile-worldbuilding-bible/) — uses dynamic blocks (parallel to Bases) for in-note rendering
