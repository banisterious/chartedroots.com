...
![Edit Person modal showing the Source tracking section with multiple sources attached to several facts](/img/cr-guide-set-up-source-tracking-modal.png)
...
![Person profile showing per-fact attribution with primary and secondary evidence badges, and a coverage summary](/img/cr-entity-attribution.png)
