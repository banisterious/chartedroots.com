...
This is the foundational worldbuilding guide. The other P0 worldbuilding guides ([custom calendar](/guides/worldbuilding/set-up-custom-calendar/), [fictional family tree](/guides/worldbuilding/build-fictional-family-tree/), [custom map](/guides/worldbuilding/create-custom-image-map/)) all assume a universe exists.
...
- **Custom** — define inline with eras, abbreviations, and epochs. See [I want to set up a custom calendar with eras](/guides/worldbuilding/set-up-custom-calendar/) for deeper coverage.

### 4. (Optional) Pick a map

Step 3. Skip if you'll use real-world maps. Otherwise select an image file and define coordinate bounds. See [I want to create a custom map of my fictional world](/guides/worldbuilding/create-custom-image-map/) for deeper coverage.
...
![Universe note showing entity tables auto-rendering for People and Events alongside the linked custom calendar](/img/cr-universe-overview.png)
...
- [I want to set up a custom calendar with eras](/guides/worldbuilding/set-up-custom-calendar/)
- [I want to build a family tree for fictional characters](/guides/worldbuilding/build-fictional-family-tree/)
- [I want to create a custom map of my fictional world](/guides/worldbuilding/create-custom-image-map/)
