...
For custom worlds that don't fit any of these, see [I want to set up a custom calendar with eras](/guides/worldbuilding/set-up-custom-calendar/) instead.

## What you'll need

- A universe note for your world. See [I want to create a fictional universe](/guides/worldbuilding/create-fictional-universe/). Optional but recommended — the built-in calendar will preselect when the universe name matches.
...
- **Custom calendar instead.** If your world is Discworld, Earthsea, the Wheel of Time, or your own creation, see [I want to set up a custom calendar with eras](/guides/worldbuilding/set-up-custom-calendar/).

## Related guides

- [I want to create a fictional universe](/guides/worldbuilding/create-fictional-universe/)
