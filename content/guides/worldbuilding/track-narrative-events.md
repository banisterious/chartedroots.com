...
- (Recommended) A custom calendar for dating events in your world's reckoning. See [I want to set up a custom calendar with eras](/guides/worldbuilding/set-up-custom-calendar/) or [I want to use a built-in calendar](/guides/worldbuilding/use-built-in-calendar/).
...
- [I want to compile a worldbuilding bible from my notes](/guides/worldbuilding/compile-worldbuilding-bible/)
