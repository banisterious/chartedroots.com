...
The workflow mirrors [I want to add my first person from scratch](/guides/research/add-first-person-manually/) — same Create Person modal, same relationship fields. The worldbuilding-specific bits are the **universe** field and (optionally) **fictional dates** in `born` / `died`.

## What you'll need

- A universe note for your world. See [I want to create a fictional universe](/guides/worldbuilding/create-fictional-universe/).
- (Optional) A custom calendar registered for that universe, if you want to use fictional dates. See [I want to set up a custom calendar with eras](/guides/worldbuilding/set-up-custom-calendar/).
...
![Edit Person modal with relationships and events populated for a fictional character](/img/cr-edit-person-modal.png)
...
- [I want to set up a custom calendar with eras](/guides/worldbuilding/set-up-custom-calendar/) — for non-Gregorian dating
