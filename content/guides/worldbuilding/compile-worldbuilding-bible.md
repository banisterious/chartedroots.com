...
- A universe note for your world. See [I want to create a fictional universe](/guides/worldbuilding/create-fictional-universe/).
...
![Universe note showing entity tables auto-rendered for People and Events alongside the linked custom calendar](/img/cr-universe-overview.png)
...
![Book Builder output: a printable PDF of a worldbuilding bible assembled from universe entities](/img/cr-book-builder-output.png)
...
- **Sharing with non-Obsidian collaborators.** Book Builder's Markdown output preserves cross-links as plain text; PDF and ODT outputs render them as references. A dedicated sharing-with-collaborators guide is queued for the deeper sharing workflow.
...
- [I want to create a fictional universe](/guides/worldbuilding/create-fictional-universe/) — prerequisite
...
- I want to share my worldbuilding bible with collaborators *(coming soon)*
