...
- (Optional) A custom calendar for the universe. See [I want to set up a custom calendar with eras](/guides/worldbuilding/set-up-custom-calendar/) — useful for dating tenures and successions in your world's reckoning.
...
![Multi-generational canvas tree generated from a Royal Families fixture](/img/cr-canvas-tree-multi-generational.png)
...
- [I want to track narrative events alongside vital ones](/guides/worldbuilding/track-narrative-events/)
