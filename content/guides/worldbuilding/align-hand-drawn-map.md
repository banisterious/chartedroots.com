...
- A custom map already created. See [I want to create a custom map of my fictional world](/guides/worldbuilding/create-custom-image-map/).
...
![Map View in alignment edit mode, with four corner handles visible on a hand-drawn map and an edit banner showing Save, Undo, Reset, and Cancel actions](/img/cr-guide-align-hand-drawn-map-edit-mode.webp)
...
- [I want to create a custom map of my fictional world](/guides/worldbuilding/create-custom-image-map/) — prerequisite
- [I want to link drilldown maps for regions](/guides/worldbuilding/link-drilldown-maps/) — pairs naturally with alignment for multi-scale worlds
